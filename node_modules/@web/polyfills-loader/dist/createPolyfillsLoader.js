...
function createLoadScriptCode(cfg, polyfills) {
    ...
    if ((polyfills && polyfills.length > 0) ||
        [SCRIPT, MODULE].some(type => (0, utils_1.hasFileOfType)(cfg, type))) {
...
function createLoadFile(file) {
    const resourcePath = (0, utils_1.cleanImportPath)(file.path);
...
async function createPolyfillsLoader(cfg) {
    let polyfillFiles = await (0, createPolyfillsData_1.createPolyfillsData)(cfg);
