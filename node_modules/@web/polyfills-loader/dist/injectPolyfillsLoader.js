...
function injectImportMapPolyfills(documentAst, headAst, cfg) {
    ...
    const polyfillSystemJs = (0, utils_1.hasFileOfType)(cfg, utils_1.fileTypes.SYSTEMJS);
...
async function injectPolyfillsLoader(htmlString, cfg) {
    ...
    const polyfillsLoader = await (0, createPolyfillsLoader_1.createPolyfillsLoader)(cfg);
