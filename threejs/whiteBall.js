...
class WhiteBall extends Ball{
    ...
    update(dt) {
        ...
        if (this.sphere.sleepState == CANNON.Body.SLEEPING) {
    ...
    hit(strength) {
        ...
        position.copy(this.sphere.position);
    ...
    onEnterHole() {
        this.sphere.velocity = new CANNON.Vec3(0);
        this.sphere.angularVelocity = new CANNON.Vec3(0);
